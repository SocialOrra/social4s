...
class PlayWSHttpConnection extends HttpConnection {
  ...
  override def get(getRequest: GetRequest)(implicit ec: ExecutionContext): Future[WSResponse] = {
  ...
  override def post[T](postRequest: PostRequest[T])(implicit ec: ExecutionContext, bodyWriteable: Writeable[T]): Future[WSResponse] = {
    client
  ...
  override def batch(batchRequest: BatchRequest)(implicit ec: ExecutionContext): Future[WSResponse] = {
