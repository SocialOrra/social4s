...
abstract class PostRequest[T](val relativeUrl: String, val headers: Seq[(String, String)], val queryString: Map[String, Seq[String]], val body: Option[T], val method: HttpMethod = PostMethod) extends Request {
